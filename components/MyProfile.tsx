    ...
    <div className="bg-white border border-black p-8">
      ...
      <div className="flex flex-col md:flex-row gap-12 items-start">
        <div className="flex flex-col items-center space-y-4">
          <div className="w-32 h-32 bg-gray-100 border border-black flex items-center justify-center overflow-hidden">
             {user.profilePhotoUrl ? (
                <img src={user.profilePhotoUrl} alt="Profile" className="w-full h-full object-cover grayscale" />
             ) : (
          ...
          {isEditing && (
             <button className="text-[9px] uppercase tracking-[0.2em] font-bold text-brand-dark-gray hover:text-black border-b border-transparent hover:border-black transition-all">
               Change Photo
             </button>
          )}
        </div>
